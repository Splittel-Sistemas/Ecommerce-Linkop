...
class ModeloUsuarios{
	...
	static public function mdlRegistroUsuarioInvitado($tabla, $datos){
	...
	static public function mdlActualizarPerfil($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET nombre = :nombre, email = :email, password = :password, foto = :foto, direccion = :direccion, codigo = :codigo, ciudad = :ciudad, telefono = :telefono WHERE id = :id");
...
/* REGISTRO DE USUARIOS AL BOLETIN  */



static public function mdlRegistroUsuarioSub($tabla, $datos){
