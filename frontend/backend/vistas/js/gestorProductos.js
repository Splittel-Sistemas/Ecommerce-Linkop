                ...
                $.ajax({
                  ...
                  success: function (respuesta) {
                    ...
                    if (localStorage.getItem("multimediaFisica") != null) {
                      ...
                      var jsonMultimediaFisica =
                        listaMultimedia.concat(jsonLocalStorage);
...
$(".tablaProductos tbody").on("click", ".btnStockProducto", function () {
  $(".previsualizarImgFisico").html("");
  ...
  $.ajax({
    ...
    dataType: "json",
    success: function (respuesta) {
      $("#modalStockProducto .idProducto").val(respuesta[0]["id"]);
      $("#modalStockProducto .tituloProducto").val(respuesta[0]["titulo"]);

      $("#modalStockProducto .cantidad").val(respuesta[0]["cantidad"]);

      /*=============================================
			GUARDAR CAMBIOS DEL PRODUCTO
			=============================================*/

      $(".guardarCambiosProductos").click(function () {
        /*=============================================
					PREGUNTAMOS SI LOS CAMPOS OBLIGATORIOS ESTÁN LLENOS
					=============================================*/

        if ($("#modalStockProducto .cantidad").val() != "") {
          /*=============================================
					   	PREGUNTAMOS SI VIENEN IMÁGENES PARA MULTIMEDIA O LINK DE YOUTUBE
					   	=============================================*/
...
function editarMiStock() {
  var idProducto = $("#modalStockProducto .idProducto").val();
  var tituloProducto = $("#modalStockProducto .tituloProducto").val();
 
  var cantidad = $("#modalStockProducto .cantidad").val();
