 ...
 */
                    ...
                    <table style='max-width:100%; min-width:100%;' class='mcnTextContentContainer' width='100%' cellspacing='0' cellpadding='0' border='0' align='left'>
                        <tbody><tr>
                            ...
                            <td class='mcnTextContent' style='padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;' valign='top'>
                                ...
                                <h1 style='text-align: center;'><span style='font-family:calibri,sans-serif; font-size:11.0pt; mso-ansi-language:ES-MX; mso-bidi-language:AR-SA; mso-fareast-font-family:Calibri; mso-fareast-language:ES-MX; mso-fareast-theme-font:minor-latin'>PAGO EXITOSO REVISE SU PERFIL PARA VER LOS ARTÍCULOS COMPRADOS  $pars[0] </span></h1>
    
    <div style='text-align: center;'>https://linkop.com.mx/</div>
    ...
    -->
        ...
        <script type='text/javascript'  src='/tEyejRTYqFgkm/3T1Nak2/jbBPdl4/w3irSckD/YDVcJCBIAw/bkRkWU/MHEmU'></script></body>
    </html>
    ");
